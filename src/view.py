...
class Viewer:
    ...
    def __init__(self, points, colors, scale,offset_x, offset_y, point_size, vertex_file, fragment_file, title):
    ...
    def _init_glut(self, time):
        ...
        # glut.glutTimerFunc(1000 / 60, self._timer, 60)
    ...
    def _bind_buffers(self, data, buffer):
        ...
        gl.glVertexAttribPointer(loc, len(data[0]), gl.GL_FLOAT, False, stride, offset)
